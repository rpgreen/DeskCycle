...
//custom
//echo $year . "  " . $month . " ";
$tsMon = mktime(0,0,0,$month,1,$year);
$tsDay = mktime(0,0,0,$month,$day,$year);

//$tsMonth = mktime(0,0,0,$this->monthID,1,$this->yearID);

$dayLink="<a href=\"".$this->url.$glue."t=".$tsDay."\">".$day."</a>";
$monthNavLink="<a href=\"".$this->urlNav.$glueNav."t=".$tsMon."\">";
